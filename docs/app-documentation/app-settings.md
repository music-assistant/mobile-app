...
- **Direct** — Connect directly to your server over [LAN](/docs/app-documentation/connection-to-server-lan.md) (default) or via a [Proxied connection](/docs/app-documentation/connectrion-to-server-proxy.md).
